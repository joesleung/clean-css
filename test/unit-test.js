...
vows.describe('clean-units').addBatch({
  ...
  'urls': cssContext({
    ...
    'strip more': [
      'a{background:url("/images/blank.png") 0 0 no-repeat}a{}a{background:url("/images/blank2.png") 0 0 no-repeat}',
      'a{background:url(/images/blank.png) 0 0 no-repeat}a{}a{background:url(/images/blank2.png) 0 0 no-repeat}'
    ],
    ...
    'keep special markers in comments (so order is important)': '/*! __ESCAPED_URL_CLEAN_CSS0__ */a{}',
